        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <motion.div
              ...
              className="bg-midnight-surface border border-midnight-border rounded-xl p-6 sm:p-8"
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-lg bg-mint-primary/10 flex items-center justify-center">
                  <Lightbulb size={20} className="text-mint-primary" />
                </div>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-lg bg-mint-primary/10 flex items-center justify-center">
                  <Zap size={20} className="text-mint-primary" />
                </div>
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-lg bg-mint-primary/10 flex items-center justify-center">
                  <Target size={20} className="text-mint-primary" />
                </div>
              ...
              <ul className="list-disc list-inside space-y-2 text-text-muted mb-4">
                <li><strong className="text-text-main">Habit Tracking</strong> with GitHub-style contribution graphs that make consistency visual and motivating</li>
                <li><strong className="text-text-main">Task Management</strong> that's fast and keyboard-friendly, designed for quick capture and execution</li>
                <li><strong className="text-text-main">Focus Sessions</strong> with integrated Pomodoro timers that sync with your workflow</li>
                <li><strong className="text-text-main">Daily Journaling</strong> with structured prompts that help you reflect and improve</li>
                <li><strong className="text-text-main">Analytics</strong> that actually matter—showing your momentum, not just raw data</li>
              </ul>
              <p className="text-text-muted leading-relaxed">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-lg bg-mint-primary/10 flex items-center justify-center">
                  <Code size={20} className="text-mint-primary" />
                </div>
