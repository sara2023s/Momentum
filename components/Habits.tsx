    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
        ...
        <div className="text-left sm:text-right">
          ...
          <div className="text-xs text-text/60 uppercase tracking-wider">Completed</div>
        </div>
      </div>
      ...
      {loading ? (
        <div className="text-center text-text/60 py-12">Loading habits...</div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-3 md:gap-4">
          {habits.map((habit) => {
            ...
            <div className="flex justify-between items-start mb-4">
               ...
               <div className={`flex items-center gap-1 text-sm font-mono ${habit.streak > 0 ? 'text-accent' : 'text-text/50'}`}>
